...
Los turnos se explicarán asumiendo que se juega por equipos, y después se hará una pequeña clarificación sobre cómo adaptarlo a juego individual.

Cuando sea tu turno, comienza por mostrar una pregunta (en el Panel de preguntas, pulsa el botón). La pregunta deberá ser de categoría aleatoria. Las categorías son Historia, Simulación, Fórmulas, y Dibujo Técnico. Historia es individual. El resto requieren dos o más personas.

Cuando se juegue sin equipo, las preguntas que requieren más personas se jugarán eligiendo un compañero entre el resto de jugadores. La persona no puede decir que no. Cuando se juegue en equipo, Simulación y Dibujo Técnico se jugarán con todo el equipo. Fórmulas se jugará con dos personas del equipo.

Una vez se resuelve la pregunta, el jugador o equipo se apuntará un bloque en la mantisa en caso de haber acertado, y no hará nada si ha fallado. Jugando individual, en caso de haberse elegido un compañero para una ronda, el compañero no ganará un bloque por acertar, pero lo perderá si falla.

## Desarrollo del juego

Cada jugador o equipo comienza con 4 bloques por rellenar, uno de cada categoría. Solo una vez ha rellenado los 4 bloques, se podrá elegir una especialidad. Elegida la especialidad, se añadirán otros cuatro bloques diferentes de distintos colores. Un turno equivale a una pregunta (se acierte o no), y una vez todos los bloques han sido rellenados el jugador o equipo que los rellene habrá ganado.

Un jugador o equipo que pierde un bloque después de haber seleccionado su especialidad no pierde su especialidad.

Una vez un jugador o equipo haya ganado, se declarará el ganador y pulsará el botón.
